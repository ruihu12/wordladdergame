...
import java.awt.event.ActionEvent;
	...
	public class mediumJumble extends javax.swing.JFrame {
	   ...
	   int i = 0;
	   public int level = 1;
	   String A[] = { "swing", "slang", "four", "print", "laptop", "control", "transfer", "victory", "smooth", "science" };
	   String B[] = { "ginws", "gsnal", "uorf", "nript", "potlap", "lortcon", "afresntr", "rotyciv", "otmsho", "ieeccns" };
	   ...
	   public static void main(String args[]) {
	       ...
	       java.awt.EventQueue.invokeLater(new Runnable() {
	           public void run() {
	               new mediumJumble().setVisible(true);
