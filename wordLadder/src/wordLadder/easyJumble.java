...
import java.awt.event.ActionEvent;
	...
	public class easyJumble extends javax.swing.JFrame {
	   ...
	   int i = 0;
	   public int level = 1;
	   String A[] = { "to", "the", "new", "sky", "six", "try", "cat", "elf", "ray", "lit" };
	   String B[] = { "ot", "het", "wne", "ysk", "ixs", "ytr", "tca", "fel", "yra", "tli" };
	   ...
	   public static void main(String args[]) {
	       ...
	       java.awt.EventQueue.invokeLater(new Runnable() {
	           public void run() {
	               new easyJumble().setVisible(true);
