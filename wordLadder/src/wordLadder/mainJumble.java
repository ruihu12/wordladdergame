...
public class mainJumble extends JFrame {
	...
	public mainJumble() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				mediumJumble mj= new mediumJumble();
				mj.show();
		...
		JLabel lblNewLabel = new JLabel("Jumble World");
